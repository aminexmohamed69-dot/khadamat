...
const buildingData: Record<Building, FloorData[]> = {
  A: [
    { id: 1, label: 'الطابق الأول',  apartments: [1, 2] },
    { id: 2, label: 'الطابق الثاني', apartments: [1, 2] },
    { id: 3, label: 'الطابق الثالث', apartments: [1, 2] },
    { id: 4, label: 'الطابق الرابع', apartments: [1, 2] },
  ],
  B: [
    { id: 1, label: 'الطابق الأول',  apartments: [1, 2] },
    { id: 2, label: 'الطابق الثاني', apartments: [1, 2] },
